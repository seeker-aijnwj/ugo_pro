...
import 'package:u_go/modules/booking_module/screens/onboarding/views/driver_transition_screen.dart';
...
import 'package:u_go/modules/booking_module/screens/passenger/history_screen.dart';
    ...
    try {
      ...
      if (newValue) {
        Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (_) => const DriverTransitionScreen()),
          (route) => false,
        );
      } else {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Mode Passager activé'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        // Bouton pour revenir à l’onglet 0 (facultatif — le back physique est géré par HomeScreen)
        leading: IconButton(
          icon: const Icon(Icons.arrow_back),
          onPressed: () {
            context.findAncestorStateOfType<HomeScreenState>()?.navigateToTab(
              0,
            );
          },
        ),
      ...
      body: uid == null
          ...
          : StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
              ...
              builder: (context, snap) {
                ...
                final role = (data['role'] ?? 'passenger').toString().trim();
